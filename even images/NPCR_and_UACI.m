%function results = NPCR_and_UACI( a, Aorig, need_display, largest_allowed_val )
% =========================================================================
% FUNCTION: 
...
%% 1. input_check 
[ height_a, width_a, depth_a ] = size( a );%edit here
[ height_b, width_b, depth_b ] = size( s1 );%edit here
...
img_a = double( a );%edit here
img_b = double( s1 );%edit here
